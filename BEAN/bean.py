...
class DB:
    ...
    def __init__(self):
        ...
        dbStructure=[
            ...
            f"CREATE TABLE IF NOT EXISTS {self.ANIMALS_TABLE} (animalID INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, age int(100) NOT NULL, type TEXT NOT NULL, owner INTEGER, FOREIGN KEY(owner) REFERENCES {self.CLIENTS_TABLE}(clientID))",
